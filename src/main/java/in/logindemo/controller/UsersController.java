package in.logindemo.controller;

import in.logindemo.model.Users;
import in.logindemo.service.UsersService;
...
public class UsersController {
    ...
    public String register(@ModelAttribute Users users) {
        ...
        Users regUser = usersService.registerUser(users.getLogin(),users.getPassword(),users.getEmail(),users.getAge(),users.getGender());
